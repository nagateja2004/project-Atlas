...
- [ ] Ensure the browser, terminal, and recording contain no Groq key or `.env` content.
...
- [ ] If live Groq calls fail, show the recorded video and evaluator JSON; do not describe a cached response as a live result.
